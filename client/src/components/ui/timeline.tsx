    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-white/70 text-sm md:text-base max-w-sm">
          My cybersecurity career evolution from penetration testing to enterprise security leadership.
        </p>
      </div>
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-black border border-white/20 flex items-center justify-center">
                <div className="h-4 w-4 rounded-full bg-white border border-white/30 p-2" />
              </div>
